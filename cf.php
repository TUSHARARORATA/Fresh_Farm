...
<html>
    <head>
        <title>chemical fertilizer</title>
    ...
    <table>
        <tr>
            <td>
                ...
                <img src="img/as.jpg" alt="Ammonium Sulphate">
                <h1>Ammonium Sulphate</h1>
            ...
            <td>
                <div class="pcard col2">
                <img src="img/an.jpg" alt="Ammonium Nitrate">
                <h1>Ammonium Nitrate</h1>
                    <p class="price">$19.99</p>
                    <input type="number" class="kg" placeholder="in kg" pattern="[0-9]"></input><br><br>
                    <input type="submit" name="addcart" class="ac" value="Add to Cart"></input>
                </div>
            ...
            <td>
                <div class="pcard col2">
                <img src="img/cn.jpg" alt="Calcium Nitrate">
                <h1>Calcium Nitrate</h1>
                    <p class="price">$19.99</p>
                    <input type="number" class="kg" placeholder="in kg" pattern="[0-9]"></input><br><br>
                    <input type="submit" name="addcart" class="ac" value="Add to Cart"></input>
                </div>
